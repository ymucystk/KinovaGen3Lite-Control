...
const Assets = ()=>{
  return (
    <a-assets>
      {/*IGUS_REBEL*/}
      <a-asset-items id="base" src="Gen3Lite_base.gltf" ></a-asset-items>
      <a-asset-items id="j0" src="Gen3Lite_j0.gltf" ></a-asset-items>
      <a-asset-items id="j1" src="Gen3Lite_j1.gltf" ></a-asset-items>
      <a-asset-items id="j2" src="Gen3Lite_j2.gltf" ></a-asset-items>
      <a-asset-items id="j3" src="Gen3Lite_j3.gltf" ></a-asset-items>
      <a-asset-items id="j4" src="Gen3Lite_j4.gltf" ></a-asset-items>
      <a-asset-items id="j5_1" src="Gen3Lite_j5_1.gltf" ></a-asset-items>
      <a-asset-items id="j5_2" src="Gen3Lite_j5_2.gltf" ></a-asset-items>
    </a-assets>
  )
}
  ...
  return (<>{visible?
    <a-entity gltf-model="#base" position="0 0 0" rotation={`0 0 0`}>
      <a-entity gltf-model="#j0" position="0 0 0" rotation={`0 ${j1_rotate} 0`}>
        <a-entity gltf-model="#j1" position="0 0.2433 0" rotation={`${j2_rotate} 0 0`}>
          <a-entity gltf-model="#j2" position="0 0.28005 0" rotation={`${j3_rotate} 0 0`}>
            <a-entity gltf-model="#j3" position="0 0.24502 0" rotation={`${j4_rotate} 0 0`}>
              <a-entity gltf-model="#j4" position="0.06702 0.15274 0" rotation={`0 ${j5_rotate} 0`}>
                <a-entity gltf-model="#j5_1" position="0 0.02165 0.03036" rotation={`${-j6_rotate} 0 0`}></a-entity>
                <a-entity gltf-model="#j5_2" position="0 0.02165 -0.03065" rotation={`${j6_rotate} 0 0`}></a-entity>
              </a-entity>
            </a-entity>
          </a-entity>
        </a-entity>
